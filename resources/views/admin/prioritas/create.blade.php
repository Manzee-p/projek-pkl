...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card create-card">
        <div class="create-header">
            <h4>Tambah Prioritas</h4>
            <p>Buat tingkat prioritas baru dalam sistem</p>
        </div>
            ...
            <form action="{{ route('prioritas.store') }}" method="POST" class="forms-sample">
                ...
                <div class="form-section-create">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-create" id="nama_prioritas" name="nama_prioritas" 
                               value="{{ old('nama_prioritas') }}" 
