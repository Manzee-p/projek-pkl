    ...
    <div class="card index-card">
        <div class="index-header">
            <div class="header-title">
                <h4>Daftar Status Tiket</h4>
                <p>Kelola semua status tiket dalam sistem</p>
            </div>
            <a href="{{ route('admin.status.create') }}" class="btn-add-status">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="empty-state">
                                    ...
                                    <h5>Belum Ada Status Tiket</h5>
                                    <p>Klik tombol "Tambah Status" untuk membuat status baru</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
