            ...
            <div class="card index-card">
                <div class="index-header">
                    <div class="header-title">
                        <h4>📋 Laporan Ditugaskan kepada Saya</h4>
                        <p>Kelola dan selesaikan laporan yang menjadi tanggung jawab Anda</p>
                    </div>
                </div>
                ...
                <div class="index-body">
                    ...
                    <div class="filter-section">
                        <form method="GET" action="{{ route('tim_teknisi.report.index') }}">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('tim_teknisi.report.index') }}" class="btn-reset">
                    ...
                    @if($reports->count() == 0)
                        <div class="empty-state">
                            ...
                            <p>Saat ini belum ada laporan yang ditugaskan kepada Anda</p>
                        </div>
                    @else
