                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">
                                        <i class="mdi mdi-calendar-star form-label-icon"></i>
                                        Event<span class="required-mark">*</span>
                                    </label>
                                    <select name="event_id" class="form-control form-control-modern" required>
                                        <option value="">Pilih Event</option>
                                        @foreach($events as $event)
                                            <option value="{{ $event->event_id }}">{{ $event->nama_event }}</option>
                                        @endforeach
                                    </select>
                                    <small class="input-hint">Event terkait dengan tiket ini</small>
                                </div>
                            </div>
                        </div>
                    </div>
