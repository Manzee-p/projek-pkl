...
@section('pageTitle', 'Riwayat Laporan')

@section('content')

@push('styles')
<style>
    /* === TYPOGRAPHY GLOBAL UNTUK RIWAYAT LAPORAN === */
...
<div class="container-fluid px-4 pt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="report-title mb-1">📋 Riwayat Laporan Saya</h3>
            <p class="report-subtitle mb-0">History semua laporan yang pernah Anda buat</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('report.index') }}" class="btn btn-outline-primary rounded-pill px-4">
                <i class="lni lni-arrow-left me-2"></i>Kembali ke Laporan Aktif
            </a>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
            <h5 class="report-card-title mb-0">Daftar Riwayat Laporan</h5>
