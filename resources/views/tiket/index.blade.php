                        ...
                        @foreach($tikets as $tiket)
                            <div class="tiket-card">
                                <div class="tiket-header">
                                    <div onclick="window.location='{{ route('tiket.show', $tiket->tiket_id) }}'" style="cursor: pointer; flex: 1;">
                                    ...
                                    <div class="text-end d-flex align-items-center gap-2">
                                        ...
                                        <a href="{{ route('tiket.edit', $tiket->tiket_id) }}" class="btn-edit" onclick="event.stopPropagation()">
                                            <i class="lni lni-pencil"></i>
                                        </a>
                                    </div>
                                </div>

                                <div onclick="window.location='{{ route('tiket.show', $tiket->tiket_id) }}'" style="cursor: pointer;">
